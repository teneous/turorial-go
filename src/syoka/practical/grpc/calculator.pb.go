...
var file_calculator_proto_rawDesc = []byte{
	...
	,
...
var file_calculator_proto_goTypes = []interface{}{
	(*Element)(nil), // 0: calculator.Element
	(*Result)(nil),  // 1: calculator.Result
}
var file_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.Calculator.Add:input_type -> calculator.Element
...
type CalculatorClient interface {
	Add(ctx context.Context, in *Element, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *Element, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
type CalculatorServer interface {
	Add(context.Context, *Element) (*Result, error)
}
...
func (*UnimplementedCalculatorServer) Add(context.Context, *Element) (*Result, error) {
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Add(ctx, req.(*Element))
	}
